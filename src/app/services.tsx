  ...
  const service = [
    {
      ...
      description:
        "Create strong web apps using the latest web tools and technology.",
    },
    {
      image: "/Images/mobileDev.jpg",
      title: "Mobile Apps design and development ",
      description:
        "We help you connect with lots of people by creating apps for iPhones, Android phones, and for all types of phones.",
    },
    {
      image: "/Images/uiuxDesign.png",
      title: "UI/UX Research and design",
      description:
        "We make your apps and websites easy to use and look great so that everyone loves using them.",
    },
    {
      image: "/Images/cloudComp.jpg",
      title: "Cloud database and backend integration",
      description:
        "We help you reach more people by setting up databases in the cloud and making sure everything works smoothly behind the scenes.",
    },
    {
      image: "/Images/aiChat.jpg",
      title: "AI Chatbot integration",
      description:
        "We help you talk to more people by adding smart chatbots to your website or app.",
    },
    {
      image: "/Images/launch.jpg",
      title: "Hosting, deployment and maintenance",
      description:
        "We handle everything from getting your website online to keeping it running smoothly.",
    },
  ];
  return (
    <section className="py-10 lg:py-28 px-8" id="service">
