  ...
  export function FeatureCard({ icon: Icon, title, children }: FeatureCardProps) {
    return (
      <Card  placeholder={''} onPointerEnterCapture={''} onPointerLeaveCapture={''}  color="transparent" shadow={false}>
        <CardBody  placeholder={''} onPointerEnterCapture={''} onPointerLeaveCapture={''}   className="grid justify-start">
          ...
          <Typography  placeholder={''} onPointerEnterCapture={''} onPointerLeaveCapture={''}  className=" font-normal !text-gray-500">
            {children}
          </Typography>
        </CardBody>
      </Card>
